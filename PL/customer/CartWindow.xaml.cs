...
public partial class CartWindow : Window
{
    ...
    // Using a DependencyProperty as the backing store for orderCommitedText.  This enables animation, styling, binding, etc...
    ...
    private void CommitOrderButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        orderCommitedText = "order commited succesfully. your order ID: " + orderID;
