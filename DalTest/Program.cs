    ...
    case 1://מוצר
     {
      ...
      DalProduct product = new DalProduct();//בaddProduct ניחוש אין לי מושג מה זה,בשביל שיכיר 
    ...
    case 3://פריט בהזמנה
     {
      ...
      DalOrderItem orderItem = new DalOrderItem();//בaddProduct ניחוש אין לי מושג מה זה,בשביל שיכיר 
